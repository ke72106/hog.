...
def swine_align(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4a
    "*** YOUR CODE HERE ***"
    n,d = player_score,opponent_score
    if n == 0 or d == 0:
        return False
    while n % d != 0:
        n,d = d,n % d
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0,score1):
        ...
        if who == 0:
            if score0 - last_score1 > running_high1:
                print(score0 - last_score1,'point(s)! The most yet for Player 0')
                running_high1 = score0 - last_score1
            last_score1 = score0
        if who == 1:
            if score1 - last_score1 > running_high1:
                print(score1 - last_score1,'point(s)! The most yet for Player 1')
                running_high1 = score1 - last_score1
            last_score1 = score1
        return announce_highest(who, last_score=last_score1, running_high=running_high1)
    return say
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    high_score = 0
    while num <= 10:
        score = average_roll_dice(num,dice)
        if score > high_score:
            high_score, result = score, num
        num += 1
    return result
